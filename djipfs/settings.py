...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'jinja2'],  # Folder for Jinja2 templates
        'APP_DIRS': False,
        'OPTIONS': {
            'autoescape': True,
            'undefined': jinja2.StrictUndefined,
            'environment': 'djipfs.jinja.env.JinjaEnvironment',  # Your custom env
            'extensions': [
    ...
    },
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Folder for DTL templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
AXES_NEVER_LOCKOUT_WHITELIST = config('AXES_NEVER_LOCKOUT_WHITELIST', cast=Csv())
